...
import org.apache.lucene.util.unimas.index.BplusTreeProducer;
...
final class SegmentCoreReaders {
    ...
    FieldBplusTree getFieldIndex(String field) {
        FieldBplusTree bplusTree = fieldIndex.get(field);
        if(bplusTree==null) {
            bplusTree = new BplusTreeProducer(segment, cfsDir, field).getBPlusTree();
            fieldIndex.put(field, bplusTree);
        }
        return bplusTree;
    }
