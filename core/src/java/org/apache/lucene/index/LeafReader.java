...
//    public Map<String, BplusTreeWapper> getBplusTreeWithField(String field) {
//
//        return SegmentInfos.getBplusTreeWithField(field);
//    }

    public abstract FieldBplusTree getFieldIndex(String field);
}
